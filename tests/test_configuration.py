...
class TestConfigurationObject(unittest.TestCase):
    def test_config_loads(self):
        ...
        self.assertEqual(conf.get_constant(['raw_store', 'why', 'rabi']), 'Somethings gotta ease your mind')
...
class TestManagerObject(unittest.TestCase):
    def test_manager_get(self):
        ...
        self.assertEqual(c0.get_constant(['raw_store', 'why', 'rabi']), 'Somethings gotta ease your mind')
